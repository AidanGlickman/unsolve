...
export function SudokuGrid({ cells, originalCells, onClickCell, frozen }: Props) {
            ...
            <div className="sudoku-row" key={rowIndex}>
                {row.map((cell, colIndex) =>
                    <button
                        ...
                        key={colIndex}>
                        <div className={`sudoku-cell-contents ${cell ? "" : "faded"}`}>
                            {cell ? cell : originalCells[rowIndex][colIndex]}
                        </div> 
                    </button>
                )}
            </div>
